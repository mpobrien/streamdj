<html>
  ...
  <body id="login-page">
    <div id="header">
      <img id="logo" src="/static/ol_med.png" />
    </div>
        {{#userinfo}}
          <div>
          ...
          <h2>Create or join a room</h2><br>
    ...
    <div id="column_1"class="column">
      ...
      <h2 id="headline">The coolest way to share<br /> music with your friends.</h2>

      <p id="blurb"><em>OUTLOUD.FM lets you create rooms where you can chat <br />
        and listen to music with your friends with a real time <br />
        collaborative playlist. Just sign in, pick a room name, and<br />
        start uploading music!</em>
      </p>
      ...
      <p id="disclaimer">
        <small>We will <b>NEVER</b> publish to your account feed without you explicitly choosing to do so.</small>
      <p>
    ...
    <div id="footer" class="centered">
      <small><a href="/static/about.html">about</a></small>
    </div>
